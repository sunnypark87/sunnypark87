...
새로운 기술과 환경을 빠르게 이해하고,
문제에 필요한 지식을 연결해 해결하는 개발자입니다. 

React/TypeScript 기반의 웹 개발부터
...
[Repository](https://github.com/sunnypark87/dongarimart)
...
**Backend & Infra**
`Node.js` `Supabase` `AWS` `GitHub Actions`

**Systems**
`C` `Zephyr RTOS` `micro-ROS`

## Links
- Email - badawa7@naver.com
